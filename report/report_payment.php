<?php
    ...
    $html .= '<table style="width:100%;"><tr><td style="width:70%;">เลขที่ประจำตัวผู้เสียภาษี : '.$data['store_tax'].'</td><td>วันที่: '.date_format(date_create($data['order_payment']),"d/m/Y").'</td></tr></table>';
